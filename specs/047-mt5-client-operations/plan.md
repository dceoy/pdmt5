...
**Branch**: `047-mt5-client-operations` | **Date**: 2026-02-05 | **Spec**: `/specs/047-mt5-client-operations/spec.md`
**Input**: Feature specification from `/specs/047-mt5-client-operations/spec.md`

## Summary

Document the MT5 client operations baseline, aligning connectivity, data access,
trading helpers, and validation behaviors with the existing pdmt5 implementation.
...
```text
specs/047-mt5-client-operations/
├── plan.md
├── research.md
├── data-model.md
├── quickstart.md
